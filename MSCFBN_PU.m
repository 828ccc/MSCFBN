...
img1=reshape(img,610*340,size(img,3));%原始HSI数据15
...
save('MS3DCN_PU_fe.mat','featuresTrain','featuresTest','net');
...
%%FBLS+guided filters
                      ...
                      C = 2^-10;   %----C: the regularization parameter for sparse regualarization
                       ...
                       best = 0.62;
                       result = [];
                       for NumRule=30                 %每个模糊子系统的模糊规则搜索范围
                          for NumFuzz=60             %模糊子系统个数搜索范围
