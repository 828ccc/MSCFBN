function   [NetoutTest,Training_time,Testing_time,TrainingAccuracy,TestingAccuracy,preditlabel]  = bls_train(train_x,train_y,test_x,test_y,Alpha,WeightEnhan,s,C,NumRule,NumFuzz);
std = 1;
tic
...
[~,yy]=max(NetoutTrain,[],2);
%train_yy = result_tra(train_y);
[~,train_yy]=max(train_y,[],2);
